...
MANIFEST = (
    ...
    ("rs/crates/services/paigasus-iam/src/adapters/boot.rs", "emits",
     "the_deferred_fallback_code_is_in_the_registry",
     "MIGRATING — the deferred boot router's app-route 503, emitted before any AppState exists"),
    ...
    ("rs/crates/services/paigasus-gateway/src/adapters/http/bytes.rs", "asserts", None, "test assertion only"),
