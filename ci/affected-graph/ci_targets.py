...
def check_self_invocation(
    ...
    # this one haystack, alone of the seven, requires the line to carry NO leading whitespace: an
...
def self_test():
    ...
    no_rg_arity_call = wired_actionlint.replace(
        '  [ "$n" -ge 105 ] || infra "check 10: release_guard.py reports $n fixtures, '
        'expected at least 105"\n',
        "",
    )
