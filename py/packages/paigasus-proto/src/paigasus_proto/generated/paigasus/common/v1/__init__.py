...
# sources: paigasus/common/v1/actor.proto, paigasus/common/v1/audit.proto, paigasus/common/v1/auditable_example.proto, paigasus/common/v1/error.proto, paigasus/common/v1/service_info.proto
...
class Actor(betterproto2.Message):
    """
...
default_message_pool.register_message("paigasus.common.v1", "Actor", Actor)
...
class AuditMetadata(betterproto2.Message):
    ...
    creator: "Actor | None" = betterproto2.field(
    ...
    modifier: "Actor | None" = betterproto2.field(
