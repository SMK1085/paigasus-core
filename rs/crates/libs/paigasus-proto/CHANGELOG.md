...
## [0.4.0](https://github.com/SMK1085/paigasus-core/compare/paigasus-proto-v0.3.0...paigasus-proto-v0.4.0) - 2026-09-26

### Added

- grant gateway_user to a person at org scope in the gateway console (SMA-676) ([#315](https://github.com/SMK1085/paigasus-core/pull/315))

## [0.3.0](https://github.com/SMK1085/paigasus-core/compare/paigasus-proto-v0.2.0...paigasus-proto-v0.3.0) - 2026-09-25

### Added

- *(rs)* interactive-user auth on the gateway chat surface, and the console playground (SMA-635)
...
- *(rs)* answer every Query and Path rejection inside the error envelope (SMA-588)
