...
async fn create(State(s): State<AppState>, Extension(ctx): Extension<AuthContext>, Json(body): Json<CreateServiceAccountBody>) -> Result<(StatusCode, Json<ServiceAccountDto>), ApiError> {
