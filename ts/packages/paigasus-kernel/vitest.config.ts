    ...
    projects: [
      {
        ...
        test: {
          name: 'node',
          environment: 'node',
          include: ['tests/sum.test.ts', 'tests/uuid7.test.ts', 'tests/prn.test.ts', 'tests/cedar.test.ts'],
      ...
      },
      {
        ...
        test: {
          name: 'browser',
          environment: 'node',
          include: ['tests/sum.wasm.test.ts', 'tests/uuid7.wasm.test.ts', 'tests/prn.wasm.test.ts', 'tests/cedar.wasm.test.ts'],
        },
        resolve: {
