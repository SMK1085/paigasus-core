...
describe('no zone hand-rolls the session cookie name', () => {
  ...
  it('checked at least lib/auth.ts, lib/config.ts, lib/console.ts, lib/nav.ts and proxy.ts', () => {
    expect(files.sort()).toEqual(
      ['lib/auth.ts', 'lib/chat-route.ts', 'lib/chat-stream.ts', 'lib/concurrency.ts', 'lib/config.ts', 'lib/console.ts', 'lib/nav.ts', 'lib/paging.ts', 'lib/settings-path.ts', 'proxy.ts'].sort(),
    );
