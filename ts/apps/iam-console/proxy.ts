...
// values must still match ts/packages/paigasus-console-core/src/correlation-header.ts: lib/correlation.ts
// reads the same two names, exported through @paigasus/console-core, from the request this proxy sets.
